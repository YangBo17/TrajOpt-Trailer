...
function trajopt_space(Time::Vector{Float64}, trajopt_set::TrajOpt_Set, cons_init::Cons_Init, limits_list::Vector, obs_list::Vector; solver_name::Symbol)
    ...
    elseif solver_name == :Mosek
        ...
        set_optimizer_attribute(solver, "MSK_DPAR_INTPNT_TOL_PFEAS", 1e-14)
        set_optimizer_attribute(solver, "MSK_DPAR_INTPNT_TOL_DFEAS", 1e-14)
        set_optimizer_attribute(solver, "MSK_DPAR_INTPNT_TOL_REL_GAP", 1e-14)
        set_optimizer_attribute(solver, "MSK_DPAR_INTPNT_TOL_MU_RED", 1e-14)
...
function trajopt_time(Time0::Vector{Float64}, trajopt_set::TrajOpt_Set, cons_init::Cons_Init, limits_list::Vector, obs_list::Vector; solver_name::Symbol)
