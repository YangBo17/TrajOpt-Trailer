...
is_failed, traj, obj_val, sol_time = NLP(traj)

#
@show diff(traj.t)[1]
@show sol_time
fig_traj = plot(fig_env, traj.x0, traj.y0, label="tractor", title="NLP-E$seed")
...
filename = "benchmark/data/NLP2016_trailer_traj_"*data_name*".jld2"
@save filename traj

method_name = "NLP"*data_name
